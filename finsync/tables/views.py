...
from finsync.utils import redirect_with_data, get_slice_and_page_end
...
def create(request, data, **kwargs):
    ...
    if request.method == 'POST':
        ...
        # Success
        data['alerts'].append(('success', 'Created successfully!', 'You have successfully create a new table.'))
...
def delete(request, data):
    ...
    if request.method == 'POST':
        ...
        # Success
        data['alerts'].append(('success', 'Deleted successfully!', 'You have successfully deleted a table.'))
        return redirect_with_data(request, data, '/tables/' + request.POST['workplace_uuid'] + '/1/')
    else:
        return custom_error_404(request, data)
...
def update(request, data, table_id):
    ...
    if request.method == 'POST':
        ...
        # Success
        data['alerts'].append(('success', 'Updated successfully!', 'You have successfully update a table.'))
