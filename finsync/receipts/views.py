...
def create(request, data, **kwargs):
 ...
 # Create new Item instance.
        ...
        # Success
        data['alerts'].append(('success', 'Created successfully!', 'You have successfully create a new receipt.'))
...
def delete(request, data):
    ...
    if request.method == 'POST':
        ...
        receipt.delete()
         ...
         # Success
        data['alerts'].append(('success', 'Deleted successfully!', 'You have successfully deleted a receipt.'))
        return redirect_with_data(request, data, '/receipts/' + request.POST['workplace_uuid'] + '/1/')
    else:
        return custom_error_404(request, data)
...
def update(request, data, receipt_id):
    ...
    if request.method == 'POST':
        ...
        # Success
        data['alerts'].append(('success', 'Updated successfully!', 'You have successfully updated a receipt.'))
