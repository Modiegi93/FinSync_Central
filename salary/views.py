...
from finsync.utils import get_slice_and_page_end, redirect_with_data
...
def delete(request, data):
    ...
    if request.method == 'POST':
        ...
        # Success
        data['alerts'].append(('success', 'Deleted successfully!', 'You have successfully deleted a record of salary.'))
...
def create(request, data, **kwargs):
    ...
    if request.method == 'POST':
        ...
        # Success
        data['alerts'].append(('success', 'Created successfully!', 'You have successfully create a new salary record.'))
...
def update(request, data, salary_id):
    ...
    if request.method == 'POST':
        ...
        # Success
        data['alerts'].append(
            ('success', 'Updated successfully!', 'You have successfully updated a record of salary.'))
