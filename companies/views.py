...
from finsync.utils import redirect_with_data, __ITEMS_NUMBER_IN_A_PAGE
...
def create(request, data):
    ...
    if request.method == 'POST':
        ...
        # Success
        data['alerts'].append(('success', 'Created successfully!', 'You have successfully created a new company.'))
...
def join(request, data):
    """Add staff that has joined the company"""
    if request.method == 'POST':
        # Collect form data.
        ...
        # Success
        data['alerts'].append(('success', 'Joined successfully!', 'You have successfully joined in a company.'))
...
def delete(request, data):
    ...
    if request.method == 'POST':
        ...
        # Success
        data['alerts'].append(('success', 'Deleted successfully!', 'You have successfully deleted a company.'))
        return redirect_with_data(request, data, '/companies/')
    else:
        return custom_error_404(request, data)
...
def update(request, data, company_uuid):
    ...
    if request.method == 'POST':
        ...
        # Success
        data['alerts'].append(
            ('success', 'Updated successfully!', 'You have successfully updated information of a company.'))
...
def fire_staff(request, data):
    ...
    if request.method == 'POST':
        ...
        # Success
        data['alerts'].append(('success', 'Deleted successfully!', 'You have successfully fired an employee.'))
